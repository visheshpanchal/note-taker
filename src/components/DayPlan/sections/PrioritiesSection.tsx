import './Sections.css'
import type { PrioritiesSectionData } from '../../../types'

interface PrioritiesSectionProps {
  section: PrioritiesSectionData
  onUpdate: (patch: Partial<PrioritiesSectionData>) => void
}

const LABELS = ['', 'Most Important', 'Second Priority', 'Third Priority']

export function PrioritiesSection({ section, onUpdate }: PrioritiesSectionProps) {
