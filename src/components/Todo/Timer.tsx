...
interface TimerProps {
  ...
  onChange: (patch: Partial<{ timerSeconds: number; timerRemaining: number; timerRunning: boolean }>) => void
}

export function Timer({ itemId: _itemId, timerSeconds, timerRemaining, timerRunning, onChange }: TimerProps) {
  ...
  function handleSetTimer() {
    const total = (parseInt(String(inputMin)) || 0) * 60 + (parseInt(String(inputSec)) || 0)
