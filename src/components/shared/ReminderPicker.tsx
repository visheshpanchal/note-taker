...
interface ReminderPickerProps {
  ...
  reminderNotified: boolean | undefined
...
function formatDisplay(isoUtc: string): string {
...
function getDefaultInput(defaultDate?: string): string {
  if (defaultDate) {
...
export function ReminderPicker({ reminderAt, reminderNotified, onChange, defaultDate }: ReminderPickerProps) {
